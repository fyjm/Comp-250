...
class Egg_Cost implements Runnable {
    ...
    public void run() {
        ...
        System.out.printf("Egg cost test passed.");
    }
}
...
class Jam_Cost implements Runnable {
    ...
    public void run() {
        ...
        System.out.printf("Jam cost test passed.");
    }
}
...
//class Basket_TotalCost implements Runnable{
...
class Basket_toString implements Runnable{
    ...
    public void run() {
        ...
        String actual = basket.toString().trim().replaceAll(" ","");
        if (!actual.equals(expected))
...
class Customer_checkOutReceipt implements Runnable{
    ...
    public void run() {
        try{
            ...
            System.out.println("Basket before checkout:\n" + basketBefore);
